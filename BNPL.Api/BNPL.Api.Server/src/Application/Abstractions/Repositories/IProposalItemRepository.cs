...
namespace BNPL.Api.Server.src.Application.Abstractions.Repositories
{
    ...
    {
        Task InsertAsync(ProposalItem proposalItem, IDbTransaction? transaction = null);
        ...
        Task<ProposalItem?> GetByIdAsync(Guid proposalItemId, IDbTransaction? transaction = null);
        Task UpdateAsync(ProposalItem item, IDbTransaction? transaction = null);
